...
public class AnimationUtils {
    ...
    public static RotateAnimation initRotateAnimation(long duration,int fromAngle,int toAngle,boolean isFillAfter,int repeatCount){
        ...
        LinearInterpolator linrInterpolator=new LinearInterpolator();
        mLoadingRotateAnimation.setInterpolator(linrInterpolator);
    ...
    public static RotateAnimation initRotateAnimation(boolean isClockWise, long duration,
        ...
        RotateAnimation mLoadingRotateAnimation=new RotateAnimation(0,endAngle,Animation.RELATIVE_TO_SELF,
